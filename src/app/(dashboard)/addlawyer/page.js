...
const AddLawyerPage = () => {
	...
	const onSubmit = async (data) => {
		...
		UploadPicture(data.image[0], data.name).then((imageUrl) => {
			if (imageUrl?.data?.data?.display_url) {
				...
				if (data?.instituteName_1) {
					experienceInfo.push({
						institutename: data?.instituteName_1,
						designation: data?.DG_1,
						department: data?.DP_1,
				...
				if (data?.instituteName_2) {
					experienceInfo.push({
						institutename: data?.instituteName_2,
						designation: data?.DG_2,
						department: data?.DP_2,
						startdate: data?.startdate_2,
						enddate: data?.enddate_2
					});
				}
				if (data?.instituteName_3) {
					experienceInfo.push({
						institutename: data?.instituteName_3,
						designation: data?.DG_3,
						department: data?.DP_3,
						startdate: data?.startdate_3,
						enddate: data?.enddate_3
					});
				}
				axios.post('/api/lawyers', lawyerInfo).then((res) => {
					if (res?.data) {
		...
		<div className="w-full max-w-[700px] p-4 mx-auto">
			...
			<form onSubmit={handleSubmit(onSubmit)} className="mt-6">
				...
				<div className="border-2 border-[#225559] p-5 rounded-lg">
					...
					<div className="mb-6">
						<label htmlFor="image" className="block mb-1 text-[14px] font-semibold">
							{' '}
							Lawyer Image*{' '}
						</label>
						<input
							...
							placeholder="Enter your name"
							className={`w-full px-4 py-[10px] bg-gray-100 border border-[#35878b4d] focus:outline-none rounded-md text-[14px] placeholder:text-[14px] ${
								errors.image ? 'border-red-500' : 'focus:border-[#35878bb6]'
							}`}
						/>
					...
					<div className="mb-6">
						<label htmlFor="department" className="block mb-1 text-[14px] font-semibold">
							Department*
						</label>
						<input
							{...register('department', {
							...
							className={`w-full px-4 py-[10px] bg-gray-100 border border-[#35878b4d] focus:outline-none rounded-md text-[14px] placeholder:text-[14px] ${
								errors.department ? 'border-red-500' : 'focus:border-[#35878bb6]'
							}`}
						/>
					...
					<div className="mb-6">
						<label htmlFor="designation" className="block mb-1 text-[14px] font-semibold">
							Designation*
						</label>
						<input
							...
							className={`w-full px-4 py-[10px] bg-gray-100 border border-[#35878b4d] focus:outline-none rounded-md text-[14px] placeholder:text-[14px] ${
								errors.designation ? 'border-red-500' : 'focus:border-[#35878bb6]'
							}`}
						/>
					...
					<div className="mb-6">
						<label htmlFor="languages" className="block mb-1 text-[14px] font-semibold">
							Languages*
						</label>
						<input
							{...register('languages', {
							...
							className={`w-full px-4 py-[10px] bg-gray-100 border border-[#35878b4d] focus:outline-none rounded-md text-[14px] placeholder:text-[14px] ${
								errors.languages ? 'border-red-500' : 'focus:border-[#35878bb6]'
							}`}
						/>
					...
					<div className="mb-6">
						<label htmlFor="practiceArea" className="block mb-1 text-[14px] font-semibold">
							Practice Area*
						</label>
						<input
							...
							className={`w-full px-4 py-[10px] bg-gray-100 border border-[#35878b4d] focus:outline-none rounded-md text-[14px] placeholder:text-[14px] ${
								errors.practiceArea ? 'border-red-500' : 'focus:border-[#35878bb6]'
							}`}
						/>
					...
					<div className="mb-6">
						<label htmlFor="experience" className="block mb-1 text-[14px] font-semibold">
							Experience*
						</label>
						<input
							...
							className={`w-full px-4 py-[10px] bg-gray-100 border border-[#35878b4d] focus:outline-none rounded-md text-[14px] placeholder:text-[14px] ${
								errors.experience ? 'border-red-500' : 'focus:border-[#35878bb6]'
							}`}
						/>
					...
					<div className="">
						...
						<textarea
							...
							className={`w-full px-4 py-[10px] bg-gray-100 border border-[#35878b4d] focus:outline-none rounded-md text-[14px] placeholder:text-[14px] ${
								errors.description ? 'border-red-500' : 'focus:border-[#35878bb6]'
							}`}
						></textarea>
				...
				<div className="border-2 border-[#225559] p-5 rounded-lg">
					<div className="mb-6">
						<label htmlFor="address" className="block mb-1 text-[14px] font-semibold">
							Lawyer Address*{' '}
						</label>
						<input
							{...register('address', {
							...
							className={`w-full px-4 py-[10px] bg-gray-100 border border-[#35878b4d] focus:outline-none rounded-md text-[14px] placeholder:text-[14px] ${
								errors.address ? 'border-red-500' : 'focus:border-[#35878bb6]'
							}`}
						/>
						{errors.address && <p className="text-red-500 text-sm mt-1">{errors.address.message}</p>}
					</div>
					<div className="mb-6">
						<label htmlFor="email" className="block mb-1 text-[14px] font-semibold">
							Lawyer Email:*{' '}
						</label>
						<input
							{...register('email', {
							...
							className={`w-full px-4 py-[10px] bg-gray-100 border border-[#35878b4d] focus:outline-none rounded-md text-[14px] placeholder:text-[14px] ${
								errors.email ? 'border-red-500' : 'focus:border-[#35878bb6]'
							}`}
						/>
						{errors.email && <p className="text-red-500 text-sm mt-1">{errors.email.message}</p>}
					</div>
					<div className="">
						<label htmlFor="phone" className="block mb-1 text-[14px] font-semibold">
							{' '}
							Phone*{' '}
						</label>
						<input
							...
							className={`w-full px-4 py-[10px] bg-gray-100 border border-[#35878b4d] focus:outline-none rounded-md text-[14px] placeholder:text-[14px] ${
								errors.phone ? 'border-red-500' : 'focus:border-[#35878bb6]'
							}`}
						/>
				...
				<div className=" border-2 border-[#225559] p-5 rounded-lg">
					<div className="mb-6">
						<label htmlFor="facebook" className="block mb-1 text-[14px] font-semibold">
							Facebook:{' '}
						</label>
						<input
							{...register('facebook', {
							...
							className={`w-full px-4 py-[10px] bg-gray-100 border border-[#35878b4d] focus:outline-none rounded-md text-[14px] placeholder:text-[14px] ${
								errors.facebook ? 'border-red-500' : 'focus:border-[#35878bb6]'
							}`}
						/>
					...
					<div className="mb-6">
						...
						<input
							...
							placeholder="Enter Profiles Link (optional) .."
							className={`w-full px-4 py-[10px] bg-gray-100 border border-[#35878b4d] focus:outline-none rounded-md text-[14px] placeholder:text-[14px] ${
								errors.linkedin ? 'border-red-500' : 'focus:border-[#35878bb6]'
							}`}
						/>
					...
					<div className="mb-6">
						...
						<input
							...
							placeholder="Enter Profiles Link (optional).."
							className={`w-full px-4 py-[10px] bg-gray-100 border border-[#35878b4d] focus:outline-none rounded-md text-[14px] placeholder:text-[14px] ${
								errors.twitter ? 'border-red-500' : 'focus:border-[#35878bb6]'
							}`}
						/>
					...
					<div className="">
						...
						<input
							...
							placeholder="Enter Profiles Link (optional).."
							className={`w-full px-4 py-[10px] bg-gray-100 border border-[#35878b4d] focus:outline-none rounded-md text-[14px] placeholder:text-[14px] ${
								errors.instagram ? 'border-red-500' : 'focus:border-[#35878bb6]'
							}`}
						/>
				...
				{experienceQn >= 1 && (
					<div className=" border-2 border-[#225559] p-5 rounded-lg relative ex_1">
						<div className={`child absolute top-1 gap-4 bg-[#225559] p-2 text-white rounded-lg right-1 `}>
							<span className={`cursor-pointer ${experienceQn > 1 && 'hidden'}`} onClick={addexperience}>
						...
						<div className="mb-6">
							<label htmlFor="instituteName_1" className="block mb-1 text-[14px] font-semibold">
								Institute Name:*{' '}
							</label>
							<input
								...
								className={`w-full px-4 py-[10px] bg-gray-100 border border-[#35878b4d] focus:outline-none rounded-md text-[14px] placeholder:text-[14px] ${
									errors.instituteName_1 ? 'border-red-500' : 'focus:border-[#35878bb6]'
								}`}
							/>
						</div>
						...
						<div className="grid grid-cols-2 gap-8">
							<div className="mb-6">
								<label htmlFor="DG_1" className="block mb-1 text-[14px] font-semibold">
									Designation:*{' '}
								</label>
								<input
									{...register('DG_1')}
									...
									className={`w-full px-4 py-[10px] bg-gray-100 border border-[#35878b4d] focus:outline-none rounded-md text-[14px] placeholder:text-[14px] ${
										errors.DG_1 ? 'border-red-500' : 'focus:border-[#35878bb6]'
									}`}
								/>
							</div>
							<div className="mb-6">
								<label htmlFor="DP_1" className="block mb-1 text-[14px] font-semibold">
									Department:*{' '}
								</label>
								<input
									{...register('DP_1')}
									...
									placeholder="Enter Email ..."
									className={`w-full px-4 py-[10px] bg-gray-100 border border-[#35878b4d] focus:outline-none rounded-md text-[14px] placeholder:text-[14px] ${
										errors.DP_1 ? 'border-red-500' : 'focus:border-[#35878bb6]'
									}`}
								/>
							</div>
						</div>
						...
						<div className="grid grid-cols-2 gap-8">
							<div className="">
								<label htmlFor="startdate_1" className="block mb-1 text-[14px] font-semibold">
									{' '}
									Start Date:{' '}
								</label>
								<input
									...
									required={institute_1 ? true : false}
									className={`w-full px-4 py-[10px] bg-gray-100 border border-[#35878b4d] focus:outline-none rounded-md text-[14px] placeholder:text-[14px] ${
										errors.startdate_1_1 ? 'border-red-500' : 'focus:border-[#35878bb6]'
									}`}
								/>
							</div>
							<div className="">
								<label htmlFor="enddate_1" className="block mb-1 text-[14px] font-semibold">
									End Date:{' '}
								</label>
								<input
									{...register('enddate_1')}
									...
									id="enddate_1"
									className={`w-full px-4 py-[10px] bg-gray-100 border border-[#35878b4d] focus:outline-none rounded-md text-[14px] placeholder:text-[14px] ${
										errors.enddate_1 ? 'border-red-500' : 'focus:border-[#35878bb6]'
									}`}
								/>
							</div>
						</div>
				...
				{experienceQn >= 2 && (
					<div className=" border-2 border-[#225559] mt-8 p-5 rounded-lg relative ex_1">
						<div className={`child absolute top-1 gap-4 bg-[#225559] p-2 text-white rounded-lg right-1 `}>
							<span className={`cursor-pointer ${experienceQn > 2 && 'hidden'}`} onClick={addexperience}>
								<FaPlus className="text-xl font-bold " />
							</span>
						...
						<div className="mb-6">
							<label htmlFor="instituteName_2" className="block mb-1 text-[14px] font-semibold">
								Institute Name:*{' '}
							</label>
							<input
								...
								placeholder="Enter Institute Name..."
								className={`w-full px-4 py-[10px] bg-gray-100 border border-[#35878b4d] focus:outline-none rounded-md text-[14px] placeholder:text-[14px] ${
									errors.instituteName_2 ? 'border-red-500' : 'focus:border-[#35878bb6]'
								}`}
							/>
						</div>
						...
						<div className="grid grid-cols-2 gap-8">
							<div className="mb-6">
								<label htmlFor="DG_2" className="block mb-1 text-[14px] font-semibold">
									Designation:*{' '}
								</label>
								<input
									{...register('DG_2')}
									...
									placeholder="Enter designation..."
									className={`w-full px-4 py-[10px] bg-gray-100 border border-[#35878b4d] focus:outline-none rounded-md text-[14px] placeholder:text-[14px] ${
										errors.DG_2 ? 'border-red-500' : 'focus:border-[#35878bb6]'
									}`}
								/>
							</div>
							<div className="mb-6">
								<label htmlFor="DP_2" className="block mb-1 text-[14px] font-semibold">
									Department:*{' '}
								</label>
								<input
									{...register('DP_2')}
									...
									placeholder="Enter Email ..."
									className={`w-full px-4 py-[10px] bg-gray-100 border border-[#35878b4d] focus:outline-none rounded-md text-[14px] placeholder:text-[14px] ${
										errors.DP_2 ? 'border-red-500' : 'focus:border-[#35878bb6]'
									}`}
								/>
							</div>
						</div>
						...
						<div className="grid grid-cols-2 gap-8">
							<div className="">
								<label htmlFor="startdate_2" className="block mb-1 text-[14px] font-semibold">
									{' '}
									Start Date:{' '}
								</label>
								<input
									...
									required={institute_2 ? true : false}
									className={`w-full px-4 py-[10px] bg-gray-100 border border-[#35878b4d] focus:outline-none rounded-md text-[14px] placeholder:text-[14px] ${
										errors.startdate_2 ? 'border-red-500' : 'focus:border-[#35878bb6]'
									}`}
								/>
							</div>
							<div className="">
								<label htmlFor="enddate_2" className="block mb-1 text-[14px] font-semibold">
									End Date:{' '}
								</label>
								<input
									{...register('enddate_2')}
									...
									id="enddate_2"
									className={`w-full px-4 py-[10px] bg-gray-100 border border-[#35878b4d] focus:outline-none rounded-md text-[14px] placeholder:text-[14px] ${
										errors.enddate_2 ? 'border-red-500' : 'focus:border-[#35878bb6]'
									}`}
								/>
							</div>
						</div>
				...
				{experienceQn >= 3 && (
					<div className=" border-2 border-[#225559] mt-8 p-5 rounded-lg relative ex_1">
						...
						<div className="mb-6">
							<label htmlFor="instituteName_3" className="block mb-1 text-[14px] font-semibold">
								Institute Name:*{' '}
							</label>
							<input
								...
								placeholder="Enter Institute Name..."
								className={`w-full px-4 py-[10px] bg-gray-100 border border-[#35878b4d] focus:outline-none rounded-md text-[14px] placeholder:text-[14px] ${
									errors.instituteName_3 ? 'border-red-500' : 'focus:border-[#35878bb6]'
								}`}
							/>
						</div>
						...
						<div className="grid grid-cols-2 gap-8">
							<div className="mb-6">
								<label htmlFor="DG_3" className="block mb-1 text-[14px] font-semibold">
									Designation:*{' '}
								</label>
								<input
									{...register('DG_3')}
									...
									placeholder="Enter designation..."
									className={`w-full px-4 py-[10px] bg-gray-100 border border-[#35878b4d] focus:outline-none rounded-md text-[14px] placeholder:text-[14px] ${
										errors.DG_3 ? 'border-red-500' : 'focus:border-[#35878bb6]'
									}`}
								/>
							</div>
							<div className="mb-6">
								<label htmlFor="DP_3" className="block mb-1 text-[14px] font-semibold">
									Department:*{' '}
								</label>
								<input
									{...register('DP_3')}
									...
									placeholder="Enter Email ..."
									className={`w-full px-4 py-[10px] bg-gray-100 border border-[#35878b4d] focus:outline-none rounded-md text-[14px] placeholder:text-[14px] ${
										errors.DP_3 ? 'border-red-500' : 'focus:border-[#35878bb6]'
									}`}
								/>
							</div>
						</div>
						...
						<div className="grid grid-cols-2 gap-8">
							<div className="">
								<label htmlFor="startdate_3" className="block mb-1 text-[14px] font-semibold">
									{' '}
									Start Date:{' '}
								</label>
								<input
									...
									required={institute_3 ? true : false}
									className={`w-full px-4 py-[10px] bg-gray-100 border border-[#35878b4d] focus:outline-none rounded-md text-[14px] placeholder:text-[14px] ${
										errors.startdate_3 ? 'border-red-500' : 'focus:border-[#35878bb6]'
									}`}
								/>
							</div>
							<div className="">
								<label htmlFor="enddate_3" className="block mb-1 text-[14px] font-semibold">
									End Date:{' '}
								</label>
								<input
									{...register('enddate_3')}
									...
									id="enddate_3"
									className={`w-full px-4 py-[10px] bg-gray-100 border border-[#35878b4d] focus:outline-none rounded-md text-[14px] placeholder:text-[14px] ${
										errors.enddate_3 ? 'border-red-500' : 'focus:border-[#35878bb6]'
									}`}
								/>
							</div>
						</div>
